...
//     <div className="h-32 rounded-t-xl" style={{ backgroundColor: '#8E3B46' }}>
//       <div className="absolute -bottom-16 left-8">
//         <div className="w-32 h-32 rounded-full border-4 border-white shadow-lg flex items-center justify-center" style={{ backgroundColor: '#F7E8D0' }}>
//           <User size={48} style={{ color: '#8E3B46' }} />
//         </div>
//       </div>
//     </div>
//     <div className="pt-20 pb-6 px-8">
//       <h1 className="text-3xl font-bold text-white mb-2">John Administrator</h1>
//       <p className="text-gray-300 text-lg">System Administrator</p>
